...
listOfPlugins.push(new HtmlWebpackPlugin({
	'application-name': 'Sol Data Consulting',
	'application-version': appVersion,
	author: 'Dustin K Greco',
	description: 'Branden Harper - Personal Company Site',
	favicon: 'favicon.ico',
	generator: 'NodeJS,Express,ReactJS',
	keywords: 'Sol Data Consulting, Branden Harper',
	template: 'siteTemplate.ejs',
